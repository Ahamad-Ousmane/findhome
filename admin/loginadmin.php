              ...
              <form action="authentifieradmin.php" method="post">
                ...
                <div class="row">
                    ...
                    <div data-mdb-input-init class="form-outline">
                      <label class="form-label m-3" for="username" id="username">Admin name</label>
                ...
                <button type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-block mb-4 mt-3 me-auto">
                  ...
                  <a href="creerAdmin.php" class="d-flex btn btn-link justify-content-center">Pas encore enregistrer? Inscrivez-vous</a>
              </form>
            </div>
          </div>
        </div>
